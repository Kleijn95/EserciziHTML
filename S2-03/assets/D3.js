...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (character.eye_color) {
    ...
    case 'blue-gray':
      ...
      break;
    default:
      // Se il colore degli occhi non corrisponde a uno dei casi, non fare nulla
      break;
  }
}
...
console.log("Lenght charactersNames prima", charactersNames.length);
for (let i = 0; i < femaleCharacters.length; i++) {
  let femaleName = femaleCharacters[i].name
  console.log(femaleName)

  let index = charactersNames.indexOf(femaleName);
  if (index !== -1) {
    charactersNames.splice(index, 1)}
}

console.log("Lenght charactersNames dopo", charactersNames.length)
